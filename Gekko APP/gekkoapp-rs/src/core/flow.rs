...
use crate::core::system::{
    check_arch_linux, desinstalar_paquetes, instalar_paquetes, is_package_installed,
    is_solus_linux, print_detected_environment, run_shell, run_shell_piped, sudo_prefix,
};
