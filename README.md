...
**GekkoApp** es un **Control Center de escritorio** (Rust + Tauri v2) para Arch Linux y Garuda. Con un clic instalas, actualizas y mantienes todo tu entorno sin tocar la terminal.

## ✨ Lo que trae

- 🖥️ **Control Center (GUI)** — desde aquí lo controlas todo: instalar, actualizar y ver las novedades con la campana 🔔.
...
- 🪟 **Presets Hyprland y Niri** — herramientas y dependencias listas.
- 🎮 **Gaming Setup** — NVIDIA, Intel o AMD.
- 📦 **Chaotic AUR** — repositorios optimizados en un clic.
...
Al terminar se abre el Control Center: **desde ahí instalas y actualizas todo lo demás**.

> Para desarrolladores (desde el código fuente):
> ```bash
> ./scripts/install.sh
> ./GekkoApp.sh --cli   # o el menú en terminal
> ```
